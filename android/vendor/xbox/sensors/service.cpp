...
#define LOG_TAG "android.hardware.sensors@1.0-service.xbox"
...
using ::android::hardware::sensors::V1_0::xbox::Sensors;
using ::android::sp;
...
int main(int /* argc */, char* /* argv */ []) {
    ...
    if (service->registerAsService() != OK) {
        ALOGE("Could not register sensors.xbox 1.0 service.");
        return 1;
    }
    joinRpcThreadpool();
